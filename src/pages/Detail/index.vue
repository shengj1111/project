          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd
                  changepirce="0"
                  :class="{ active: saleAttr.isChecked == 1 }"
                  v-for="saleAttr in attr.spuSaleAttrValueList"
                  :key="saleAttr.id"
                  @click="changeActive(saleAttr, attr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  @change="inputSkuNum"
                />
                <a class="plus" @click="changeSkuNum(1)"> + </a>
                <a class="mins" @click="changeSkuNum(-1)"> - </a>
              </div>
              <div class="add">
                <a @click="sendShopInfo">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
